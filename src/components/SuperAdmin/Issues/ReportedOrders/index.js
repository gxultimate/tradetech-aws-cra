...
let rows = listOfReport.filter(rep=>  rep.report_Type === 'Order Report').map(report =>{
    return(createData(
      report.report_ID,report.account_ID,report.report_Detail,report.report_Date,report.report_Sender
    ))
  })
...
const headCells = [
  ...
  { id: 'ordID', numeric: false, disablePadding: false, label: 'order #' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" id={labelId} scope="row" >{row.ordID}</TableCell>
