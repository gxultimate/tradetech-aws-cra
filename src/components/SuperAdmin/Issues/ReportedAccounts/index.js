...
let rows = listOfReport.filter(rep => rep.report_Type === 'Account Report').map(report =>{
  return(createData(
    report.report_ID,report.account_ID,report.report_Sender,report.report_Detail,report.report_Date
  ))
})
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" id={labelId} scope="row" >{row.accID}</TableCell>
