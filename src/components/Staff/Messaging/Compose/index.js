...
import React, { Component } from 'react'
 ...
 class ComposeMessage extends Component {
  componentDidMount(){
    let{staffStore:{getAccounts,getMessage,getDistributors}}=this.props;
     getDistributors()
    getMessage()
}
    render() {
let {staffStore:{listOfDistributors,message,addMessage}}=this.props;
...
export default inject('staffStore')(observer(ComposeMessage))