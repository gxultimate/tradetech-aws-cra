				...
				<Grid container direction="row" justify="flex-start" alignItems="flex-start">
							...
							<Grid item xs={4}>
								<TextField
									...
									onChange={(account_fName) => {
										...
										account.setProperty(
											'account_ID',
											`${date.getFullYear()}-${getHash(account_fName.target.value)}-${Math.floor(
										...
										account.setProperty(
											'account_username',
											account_fName.target.value.split(' ')[0] + '123'
										);
									}}
								/>
							</Grid>
							...
							<Grid item xs={4}>
								<TextField
									...
									onChange={(account_lName) => {
										...
										account.setProperty(
											'account_password',
											account_lName.target.value.split(' ')[0] + '!123'
										);
									}}
								/>
							</Grid>
					...
					>
						...
						<Select
							labelId="demo-simple-select-outlined-label"
							id="demo-simple-select-outlined"
							onChange={(account_contract) => {
								account.setProperty('account_contract', account_contract.target.value);
							}}
							labelWidth={labelWidth}
						>
					...
					>
						...
						<Select
							...
							id="demo-simple-select-outlined"
							onChange={(staff_Role) => {
								account.setProperty('staff_Role', staff_Role.target.value);
							}}
							labelWidth={labelWidth}
						>
