...
class OrderInfo extends Component {
    render() {
let {employeeStore:{order,listOfDistributors,listOfOrder,listOfUsers}}=this.props;
  ...
  <Typography variant='subtitle2'><span style={{fontWeight:'bold'}}>INVOICE #: </span>{order.orderID}</Typography>
        ...
        <Grid item xs={6} sm={6}>
         <Grid container xs={12} sm={12}>
             ...
             <Grid item xs={12} sm={12} >
  <span>{vendor.distributor_fName} {vendor.distributor_mName} {vendor.distributor_lName}</span>
  
             </Grid>
             <Grid item xs={12} sm={12} >
  <span>{vendor.distributor_warehouseName}</span>
  
             </Grid>
             <Grid item xs={12} sm={12} >
  <span>{vendor.distributor_address}</span>
             </Grid>
             <Grid item xs={12} sm={12} >
  <span>{vendor.distributor_contactNo}</span>
             </Grid>
             <Grid item xs={12} sm={12} >
  <span>{vendor.distributor_emailAddress}</span>
             </Grid>
...
export default inject('employeeStore')(observer(OrderInfo))
