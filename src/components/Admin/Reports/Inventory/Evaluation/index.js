...
const useStyles = makeStyles((theme) => ({
 ...
 function SalesByCustomer() {
  ...
  <Grid item xs={8} style={{textAlign:"left",margin:"8px"}}> <Typography variant="subtitle2"> Inventory Evaluation as of &nbsp; <MaterialUIPickers/>&nbsp; to &nbsp;  <MaterialUIPickers/></Typography> </Grid>
  <Grid item xs={3} >     
