...
function createData(name, item, brand, uom, stocks) {
  return { name, item, brand, uom, stocks };
}
...
let rows = listofProducts.map(prod => {
  ...
  prod.product_ID,prod.product_Name,prod.product_Brand,prod.product_UoM,prod.product_Stocks
...
function ReplenishTableHead(props) {
