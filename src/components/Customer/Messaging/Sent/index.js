...
import moment from 'moment'
 class SentMsg extends Component {
    render() {
let {customerStore:{listOfMessage}}=this.props;
...
let sentmsg =listOfMessage.filter(msg=> msg.sender_ID === myAccount.account_ID).map(sent=>{
...
export default inject('customerStore')(observer(SentMsg))
